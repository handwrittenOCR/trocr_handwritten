...
Les images doivent avoir des extensions en minuscules. Si besoin, faire commande ci apres:
...
def convert_txt_to_jsonl(txt_path, path_to_images):
...
def convert_directory(path_to_images, txt_dir, output_path):
    ...
    with open(output_path, "w") as f:
        for txt_file in txt_files:
            json_entry = convert_txt_to_jsonl(txt_file, path_to_images)
...
#!python trocr_handwritten/parse/split_and_push.py --path_to_images "data/20250111_bagnards_annotated/images" --path_to_labels "data/20250111_bagnards_annotated/labels" --path_to_output "data/20250111_bagnards_annotated/images/metadata.jsonl"
