...
def process_image_set(df, path_folder, config):
    """
    Convert the annotations to YOLO format and log the class distribution

    Args:
        df (pd.DataFrame): DataFrame with the annotations of areas in the images
        path_folder (str): Path to the folder containing the images and annotations
