...
TCL_CC='/croot/tk_1714770554345/_build_env/bin/aarch64-conda-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /work/m24063/m24063bglm/trocr_handwritten/.venv_layout/include -fdebug-prefix-map=/croot/tk_1714770554345/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/work/m24063/m24063bglm/trocr_handwritten/.venv_layout=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /work/m24063/m24063bglm/trocr_handwritten/.venv_layout/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -Wl,-rpath-link,/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -L/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/croot/tk_1714770554345/_build_env/bin/aarch64-conda-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/croot/tk_1714770554345/work/tcl8.6.14/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/include'
...
# compiled.
TCL_SRC_DIR='/croot/tk_1714770554345/work/tcl8.6.14'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/croot/tk_1714770554345/work/tcl8.6.14/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1714770554345/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib/libtclstub8.6.a'
