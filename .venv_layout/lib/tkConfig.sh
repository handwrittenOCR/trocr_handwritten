...
# installed.
TK_PREFIX='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/croot/tk_1714770554345/work/tk8.6.14/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/include'
...
# compiled.
TK_SRC_DIR='/croot/tk_1714770554345/work/tk8.6.14'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/croot/tk_1714770554345/work/tk8.6.14/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1714770554345/work/tk8.6.14/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/work/m24063/m24063bglm/trocr_handwritten/.venv_layout/lib/libtkstub8.6.a'
